...
export default function useSolicitacaoPagamento() {
  ...
  async function handleSaveClick() {
    ...
    const novasolicitacao: ISolicitacaoPagamento = {
      ...
      TMOV_T_DESCIDFORMAPAGTO: solicitacaoPagamento.TMOV_T_DESCIDFORMAPAGTO || "Boleto",
      TMOV_T_IDFORMAPAGTO: solicitacaoPagamento.TMOV_T_IDFORMAPAGTO || "1",
    ...
    formDataResult.push({
      name: "hidCameFromGestaoContrato",
      value: "true"
    });
